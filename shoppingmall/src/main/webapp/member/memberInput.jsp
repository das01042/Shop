...
<body>
	...
	<form class="m_form" action='../memberInsert.do' method='post'>
		...
		<div class="m_div">
			<p class="m_p">
				아이디<br> <input type='text' name='id' placeholder="ID입력">
			</p>
			<br>
			<p class="m_p">
				비밀번호 입력<br> <input type='password' name='password'
					placeholder="PW입력">
			</p>
			<br>
			<p class="m_p">
				이름 입력<br> <input type='text' name='name' placeholder="이름입력">
			</p>
			<br>
			<p class="m_p">
				이메일 입력<br> <input type='email' name='email'
